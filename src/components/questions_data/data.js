export default [
  [
    {
        question:
          "What's your main reason for your score? Please be 100% honest: we need your feedback really to improve Hotjar.",
        answers: [
    ...
    {
      question: "What's your main reason for your score?",
      answers: [
        "To keep track of event history",
        "To enhance components",
        "Free up resources",
  ...
  [
    {
      question:
        "What's your main reason for your score?",
      answers: [
        "To keep track of event history",
        "To enhance components",
        "Free up resources",
  ...
  [
    ...
    {
      question:
        "Please be 100% honest: we need your feedback really to improve Hotjar.",
      answers: [
        "To keep track of event history",
        "To enhance components",
        "Free up resources",
    ...
    {
      question:
        "What's your main reason for your score? we need your feedback really to improve Hotjar.",
      answers: [
        "To keep track of event history",
        "To enhance components",
        "Free up resources",
    ...
    {
      question:
        "We can go for keys when there is possibility that our user could change the life data?",
      answers: ["Ref","Keys", "Both", "Others"],
      correct: 1,
      optionType: "word",
      answerType: "single",
